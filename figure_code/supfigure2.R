library(ggplot2)
# Rural vs urban -----
df <- read.csv("figure/figure3_logit1.csv")
...
# Number of floors -----
df <- read.csv("figure/figure3_logit2.csv")
ggplot(df, aes(x = level, y= logit, group=Symptom, color=Symptom))+
  geom_line(size = 0.8)+
  geom_errorbar(aes(ymin=logit_l, ymax=logit_u), color = 'black', alpha = 1, size=0.6, width=0)+
  geom_point(shape = 19, size = 2)+
...
# Units per floor -----
df <- read.csv("figure/figure3_logit3.csv")
ggplot(df, aes(x = level, y= logit, group=Symptom, color=Symptom))+
  geom_line(size = 0.8)+
  geom_errorbar(aes(ymin=logit_l, ymax=logit_u), color = 'black', alpha = 1, size=0.6, width=0)+
  geom_point(shape = 19, size = 2)+
...
df <- read.csv("figure/figure3_logit4.csv")
ggplot(df, aes(x = level, y= logit, group=Symptom, color=Symptom))+
  geom_line(size = 0.8)+
  geom_errorbar(aes(ymin=logit_l, ymax=logit_u), color = 'black', alpha = 1, size=0.6, width=0)+
  geom_point(shape = 19, size = 2)+
...
# Household income -----
df <- read.csv("figure/figure3_logit5.csv")
ggplot(df, aes(x = level, y= logit, group=Symptom, color=Symptom))+
  geom_line(size = 0.8)+
  geom_errorbar(aes(ymin=logit_l, ymax=logit_u), color = 'black', alpha = 1, size=0.6, width=0)+
  geom_point(shape = 19, size = 2)+
...
# Education -----
df <- read.csv("figure/figure3_logit6.csv")
ggplot(df, aes(x = level, y= logit, group=Symptom, color=Symptom))+
  geom_line(size = 0.8)+
  geom_errorbar(aes(ymin=logit_l, ymax=logit_u), color = 'black', alpha = 1, size=0.6, width=0)+
  geom_point(shape = 19, size = 2)+
...
df <- read.csv("figure/figure3_logit7.csv")
ggplot(df, aes(x = level, y= logit, group=Symptom, color=Symptom))+
  geom_line(size = 0.8)+
  geom_errorbar(aes(ymin=logit_l, ymax=logit_u), color = 'black', alpha = 1, size=0.6, width=0)+
  geom_point(shape = 19, size = 2)+
...
# Age -----
df <- read.csv("figure/figure3_logit8.csv")
ggplot(df, aes(x = level, y= logit, group=Symptom, color=Symptom))+
  geom_line(size = 0.8)+
  geom_errorbar(aes(ymin=logit_l, ymax=logit_u), color = 'black', alpha = 1, size=0.6, width=0)+
  geom_point(shape = 19, size = 2)+
